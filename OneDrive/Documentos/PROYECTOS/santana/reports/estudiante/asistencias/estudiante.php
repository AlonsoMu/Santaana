<page>
  ...
  <div class="container">
    ...
    <table class='table'>
      ...
      <thead>
        <tr class='bg-primary text-light text-center'>
          ...
          <th class='pt-2 pb-2 text-sm'>Hora Ingreso</th>
          <th class='pt-2 pb-2 text-sm'>Hora Salida</th>
          <th class='pt-2 pb-2 text-sm'>Fecha Registro</th>
        </tr>
      </thead>
    ...
    function agregarFila($i, $arreglo = [])
    {
      ...
      <tr class='text-center text-sm'>
        <td class='pt-2 pb-2 text-sm'>{$i}</td>
        <td class='pt-2 pb-2 text-sm'>{$arreglo['horaentradaalu']}</td>
        <td class='pt-2 pb-2 text-sm'>{$arreglo['horasalidaalu']}</td>
        <td class='pt-2 pb-2 text-sm'>{$arreglo['fecharegistro']}</td>
      </tr>
    ";
    }
  ...
  <div class="container mt-5">
    ...
    <?php if (count($datos) == 0) : ?>
      <p class='mt-5 text-sm'>No se encontró ningún de registro de asistencia</p>
    <?php endif; ?>
  </div>
</page>